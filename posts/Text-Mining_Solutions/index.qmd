...
1.  Yes, we can predict hate speech!
2.  This shows us the computed accuracy, which is 71,5 %!
    1.  It also shows us, that we have 92 % specificity. This means the predictions is correct to the already classified data (c1). The specificity is the confirmation security.
