...
Because of the run-time, I have decided to go with the v-fold-cross-validation. We have a large amount of data with extremely extensive recipes, so the run-time would be enormous, if we would try another resampling option, e. g. bootstrapping.
