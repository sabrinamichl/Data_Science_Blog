...
The picture, is from <a href="https://pixabay.com/de/users/geralt-9301/?utm_source=link-attribution&amp;utm_medium=referral&amp;utm_campaign=image&amp;utm_content=7691355">Gerd Altmann</a> 
at <a href="https://pixabay.com/de//?utm_source=link-attribution&amp;utm_medium=referral&amp;utm_campaign=image&amp;utm_content=7691355">Pixabay</a>
...
# 9. Decide For A Model
```{r}
collect_metrics(l1_82_wf_fit) %>% 
  bind_rows(collect(l2_83_wf_fit)) %>% 
  bind_rows(collect(l1_84_wf_fit)) %>% 
  bind_rows(collect(l2_85_wf_fit)) %>% 
  bind_rows(collect(l1_86_wf_fit)) %>% 
  bind_rows(collect(l2_87_wf_fit)) %>% 
