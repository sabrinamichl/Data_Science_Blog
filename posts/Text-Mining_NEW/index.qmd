...
> There is a small difference between both repetitions, especially in the area of sensitivity = 0.75.
...
> So this model has an estimated ppv of 64,2 %.
...
> There is almost no discernible difference between the two repetitions.
...
> So this model has an estimated ppv of 65,3 %, so it is a little bit better than the model before.
...
> The L1-TF-IDF model is until now the best model with a ppv of 65,5 %.
...
> So this model has an estimated ppv of 67,6 %. So this one is the best model of all.
